...
{
//messages qui seront envoyés en cas d'erreur (il serait plus facile de les traduire avec cette structure)
    private $key;
    private $rule;
    ...
    public function __toString() //pour convertir les objets ValidationError en string
    {
